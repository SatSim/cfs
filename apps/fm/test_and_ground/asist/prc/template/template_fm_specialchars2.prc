...
;                               removed all but the First test in order to
...
write ";*********************************************************************"
write ";  Step 2.3: Special Characters First test "
write ";*********************************************************************"
Invalid_Create = """"
OSError_Create = """"
Allowed_Create = """"
...
FOR testNameNum = 1 to totaltests DO
  ...
  testDirName = fileSystem & forwardSlash & %name("testchar" & testNameNum) & beginDirName & endDirName
  testFileName = testDestDir & forwardSlash & %name("testchar" & testNameNum) & beginFileName & endFileName & extension
  testFileNameOnly = %name("testchar" & testNameNum) & beginFileName & endFileName & extension
  testDownloadDir = fsDownloadDir & forwardSlash & %name("testchar" & testNameNum) & beginDirName & endDirName
...
write ""
write ";*********************************************************************"
write ";  End procedure $sc_$cpu_fm_specialchars2                            "
write ";*********************************************************************"
ENDPROC
