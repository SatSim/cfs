...
;                               removed all but the Last test in order to
...
write ";*********************************************************************"
write ";  Step 2.5: Special Characters Last test "
write ";*********************************************************************"
Invalid_Create = """"
OSError_Create = """"
Allowed_Create = """"
...
FOR testNameNum = 1 to totaltests DO
  ...
  testDirName = fileSystem & forwardSlash & beginDirName & endDirName & %name("testchar" & testNameNum)
  testFileName = testDestDir & forwardSlash & beginFileName & endFileName & %name("testchar" & testNameNum) & extension
  testFileNameOnly = beginFileName & endFileName & %name("testchar" & testNameNum) & extension
  testDownloadDir = fsDownloadDir & forwardSlash & beginDirName & endDirName & %name("testchar" & testNameNum)
...
write ""
write ";*********************************************************************"
write ";  End procedure $sc_$cpu_fm_specialchars4                            "
write ";*********************************************************************"
ENDPROC
