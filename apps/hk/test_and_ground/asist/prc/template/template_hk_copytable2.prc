PROC $sc_$cpu_hk_copytable2
;*******************************************************************************
;  Test Name:  hk_copytable2
...
;      each output packet. ÊSimilar to Table 1, but change 1 input packet id, 1
;      output packet id, and size of 1 output packet, data from 1 input packet
;      should be output in only output packet 2.  Used for: ÊBasicHousekeeping,
;      MissingData, StressTableLoad;
;  Requirements Tested
;       None
;
...
;	05/09/08 	Barbie Medina	Original Procedure.
;       05/28/08	Barbie Medina	Corrected error in offset values
...
write ";*********************************************************************"
write ";  Step 1.0:  Define Copy Table 2. "
write ";*********************************************************************"
; Entry 1
entry = 1
...
for entry=59 to HK_COPY_TABLE_ENTRIES do
...
s create_tbl_file_from_cvt("$CPU",appid,"Copy Table 2","hk_cpy_tbl.tbl",HKCopyTblName,"$SC_$CPU_HK_CopyTable[1].InputMid",endmnemonic)


write ";*********************************************************************"
write ";  End procedure $sc_$cpu_hk_copytable2  "
write ";*********************************************************************"
ENDPROC
