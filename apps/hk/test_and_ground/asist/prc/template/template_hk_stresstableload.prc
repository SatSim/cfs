PROC $sc_$cpu_hk_stresstableload
;*******************************************************************************
;  Test Name:  hk_stresstableload
;  Test Level: Build Verification
;  Test Type:  Functional
;
;  Test Description
;       The purpose of this test is to stress Housekeeping (HK) by loading a
;       new copy table 4 times in a row.  
;
;  Requirements Tested
...
;       06/04/08        Barbie Medina   Removed us to ut_tlmupdate from the 
;                                       wait for output packets to update
...
write ";*********************************************************************"
write ";  Step 3.1: Generate and upload copy table 3"
write ";*********************************************************************"
...
write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hk_stresstableload                          "
write ";*********************************************************************"
ENDPROC
