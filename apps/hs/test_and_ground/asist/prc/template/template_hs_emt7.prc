...
;	that contains two entries for applications that will never execute.
;
;  Requirements Tested
;       None
;
...
;					Added variables for app and table names
...
;; Entry 6
$SC_$CPU_HS_EMT[6].AppName = "UK_APP1"
$SC_$CPU_HS_EMT[6].NullTerm = 0
$SC_$CPU_HS_EMT[6].EventID = 10
$SC_$CPU_HS_EMT[6].ActionType = HS_EMT_ACT_APP_RESTART

;; Entry 7
$SC_$CPU_HS_EMT[7].AppName = "UK_APP2"
$SC_$CPU_HS_EMT[7].NullTerm = 0
$SC_$CPU_HS_EMT[7].EventID = 10
$SC_$CPU_HS_EMT[7].ActionType = HS_EMT_ACT_APP_DELETE

for index = 8 to HS_MAX_CRITICAL_EVENTS do
...
s create_tbl_file_from_cvt ("$CPU",apid,"Event Monitoring Table Load 7","hs_def_emt7",emtTblName,"$SC_$CPU_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_emt7 "
write ";*********************************************************************"
ENDPROC
