...
;	that contains invalid data. Invalid data is a non-zero value for the
;	NullTerm variable or an ActionType larger that the defined parameters
;	HS_EMT_ACT_LAST_NONMSG + HS_MAX_MSG_ACT_TYPES.
;
;  Requirements Tested
;       None
;
...
$SC_$CPU_HS_EMT[2].NullTerm = 5
$SC_$CPU_HS_EMT[2].EventID = 10
$SC_$CPU_HS_EMT[2].ActionType = HS_EMT_ACT_APP_DELETE
...
$SC_$CPU_HS_EMT[6].ActionType = HS_EMT_ACT_LAST_NONMSG + HS_MAX_MSG_ACT_TYPES + 1
...
s create_tbl_file_from_cvt ("$CPU",apid,"Event Monitoring Table Invalid Load","hs_def_emt8",emtTblName,"$SC_$CPU_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_emt8 "
write ";*********************************************************************"
ENDPROC
