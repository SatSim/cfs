...
$SC_$CPU_HS_EMT[6].ActionType = HS_EMT_ACT_PROC_RESET
...
s create_tbl_file_from_cvt ("$CPU",apid,"Event Monitoring Table Load 3","hs_def_emt3",emtTblName,"$SC_$CPU_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_emt3 "
write ";*********************************************************************"
ENDPROC
