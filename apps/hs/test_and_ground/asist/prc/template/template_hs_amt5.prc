...
;	Table that contains a cFE Non-Core Application that triggers an 
;	Application Restart when the application fails to check-in
;
;  Requirements Tested
;       None
;
...
$SC_$CPU_HS_AMT[6].ActionType = HS_AMT_ACT_APP_RESTART
...
s create_tbl_file_from_cvt ("$CPU",apid,"App Monitoring Table Load 5","hs_def_amt5",amtTblName,"$SC_$CPU_HS_AMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_amt5 "
write ";*********************************************************************"
ENDPROC
