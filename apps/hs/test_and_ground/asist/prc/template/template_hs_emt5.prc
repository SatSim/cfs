...
;	that contains an entry for the HS_NOOP event with an action to send a
;	Software Bus (SB) message
;
;  Requirements Tested
;       None
;
...
$SC_$CPU_HS_EMT[6].ActionType = HS_EMT_ACT_LAST_NONMSG+2
...
s create_tbl_file_from_cvt ("$CPU",apid,"Event Monitoring Table Load 5","hs_def_emt5",emtTblName,"$SC_$CPU_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_emt5 "
write ";*********************************************************************"
ENDPROC
