...
$SC_$CPU_HS_EMT[6].ActionType = HS_EMT_ACT_APP_DELETE
...
s create_tbl_file_from_cvt ("$CPU",apid,"Event Monitoring Table Load 4","hs_def_emt4",emtTblName,"$SC_$CPU_HS_EMT[1].AppName",endmnemonic)
