...
;	Table that contains a cFE Core Application that triggers an Software
...
$SC_$CPU_HS_AMT[4].ActionType = HS_AMT_ACT_LAST_NONMSG+1
...
s create_tbl_file_from_cvt ("$CPU",apid,"App Monitoring Table Load 4","hs_def_amt4",amtTblName,"$SC_$CPU_HS_AMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_hs_amt4 "
write ";*********************************************************************"
ENDPROC
