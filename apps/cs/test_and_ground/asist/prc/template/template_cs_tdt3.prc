...
;	for the Checksum Application that contains an invalid state.
;
;  Requirements Tested:
;	None
;
...
$SC_$CPU_CS_TBL_DEF_TABLE[2].Name = tblResTblName
...
$SC_$CPU_CS_TBL_DEF_TABLE[6].Name = CSAppName & "." & CS_DEF_APP_TABLE_NAME
...
$SC_$CPU_CS_TBL_DEF_TABLE[8].Name = CSAppName & "." & CS_RESULTS_APP_TABLE_NAME
$SC_$CPU_CS_TBL_DEF_TABLE[9].State = CS_STATE_EMPTY
$SC_$CPU_CS_TBL_DEF_TABLE[9].Name = ""
$SC_$CPU_CS_TBL_DEF_TABLE[10].State = 7
$SC_$CPU_CS_TBL_DEF_TABLE[10].Name = "IN_VALID_Table"

;; Clear out the remaining entries in the table
for i = 11 to CS_MAX_NUM_TABLES_TABLE_ENTRIES-1 do
...
s create_tbl_file_from_cvt ("$CPU",defTblId,"Table Definition Table Invalid State","tbl_def_tbl_invalid",tblDefTblName,"$SC_$CPU_CS_TBL_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_cs_tdt3                              "
write ";*********************************************************************"
ENDPROC
