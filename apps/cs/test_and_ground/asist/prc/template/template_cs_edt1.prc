...
s create_tbl_file_from_cvt ("$CPU",defTblId,"EEPROM Memory Definition Table Load 1","eeprom_def_ld_1",eeDefTblName,"$SC_$CPU_CS_EEPROM_DEF_TABLE[0].State",endmnemonic)
