PROC $sc_$cpu_cs_runbuildtests (directorySpec)
;*******************************************************************************
...
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_appcode",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_appcode")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_corecode",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_corecode")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_gencmds",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_gencmds")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_nvmem",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_nvmem")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_reset",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_reset")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_table",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_table")
endif
wait 2
...
write ";*********************************************************************"
if (directorySpec <> "") then
  s ut_runproc("$sc_$cpu_cs_usermem",directorySpec)
else
  s ut_runproc("$sc_$cpu_cs_usermem")
endif
wait 2

write ";*********************************************************************"
write ";  End procedure $sc_$cpu_cs_runbuildtests                           "
write ";*********************************************************************"
ENDPROC
