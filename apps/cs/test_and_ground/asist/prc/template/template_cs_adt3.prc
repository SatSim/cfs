...
s create_tbl_file_from_cvt ("$CPU",defAppId,"App Definition Table Invalid State","app_def_tbl_invalid",appDefTblName,"$SC_$CPU_CS_APP_DEF_TABLE[0].State",endmnemonic)
