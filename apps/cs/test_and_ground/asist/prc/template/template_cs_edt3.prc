...
s create_tbl_file_from_cvt ("$CPU",defTblId,"EEPROM Definition Table Invalid Load","eeprom_def_ld_2",eeDefTblName,"$SC_$CPU_CS_EEPROM_DEF_TABLE[0].State",endmnemonic)
