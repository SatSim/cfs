...
;	Table for the Checksum Application containing null entries between valid
;	entries.
;
;  Requirements Tested:
;	None
...
s create_tbl_file_from_cvt ("$CPU",defAppId,"App Definition Table Load 2","app_def_tbl_ld_2",appDefTblName,"$SC_$CPU_CS_APP_DEF_TABLE[0].State",endmnemonic)

write ";*********************************************************************"
write ";  End procedure $SC_$CPU_cs_adt2                              "
write ";*********************************************************************"
ENDPROC
