...
s create_tbl_file_from_cvt ("$CPU",defTblId,"Memory Definition Empty Table Load","usrmemdefemptytbl",memDefTblName,"$SC_$CPU_CS_MEM_DEF_TABLE[0].State",endmnemonic)
