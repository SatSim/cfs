...
s create_tbl_file_from_cvt ("$CPU",defTblId,"User-defined Memory Definition Table Invalid Load","usrmem_def_invalid",memDefTblName,"$SC_$CPU_CS_MEM_DEF_TABLE[0].State",endmnemonic)
...
s create_tbl_file_from_cvt ("$CPU",defTblId,"User-defined Memory Definition Table Invalid Load","usrmem_def_invalid2",memDefTblName,"$SC_$CPU_CS_MEM_DEF_TABLE[0].State",endmnemonic)
wait 5
...
s create_tbl_file_from_cvt ("$CPU",defTblId,"User-defined Memory Definition Table Invalid Load","usrmem_def_invalid3",memDefTblName,"$SC_$CPU_CS_MEM_DEF_TABLE[0].State",endmnemonic)
wait 5
