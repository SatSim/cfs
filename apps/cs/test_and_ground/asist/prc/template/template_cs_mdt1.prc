...
s create_tbl_file_from_cvt ("$CPU",defTblId,"User Memory Definition Table Load 1","usrmem_def_ld_1",memDefTblName,"$SC_$CPU_CS_MEM_DEF_TABLE[0].State",endmnemonic)
