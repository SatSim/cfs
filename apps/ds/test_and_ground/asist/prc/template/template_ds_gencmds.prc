...
s ftp_file("CF:0/apps", "ds_gcfile.tbl", destFileName, "$CPU", "P")
s ftp_file("CF:0/apps", "ds_gcfilter.tbl", filterFileName, "$CPU", "P")
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000200B0"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000200B0"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc000000201B0"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc000000201B0"
endif
...
if ("$CPU" = "CPU2") then
  rawcmd = "19BBc0000001AA"
elseif ("$CPU" = "CPU3") then
  rawcmd = "1ABBc0000001AA"
endif
