...
s ftp_file("CF:0/apps", "ds_movefile.tbl", destFileName, "$CPU", "P")
s ftp_file("CF:0/apps", "ds_movefilter.tbl", filterFileName, "$CPU", "P")
...
s load_start_app ("FM","$CPU","FM_AppMain")
...
if ($SC_$CPU_DS_FileState[seqFileEntry].FileName <> "") then
  ...
  /$SC_$CPU_FM_DirListTlm DirName=pathName Offset=0
  wait 10
  ...
  /$SC_$CPU_FM_DirListTlm DirName=moveDirName Offset=0
  wait 10
